...
var ReceiverMethodSubscription = /** @class */ (function () {
    function ReceiverMethodSubscription(connection, receiverMethod) {
        var _this = this;
        this.connection = connection;
        this.receiverMethod = receiverMethod;
        this.dispose = function () {
            for (var _i = 0, _a = _this.receiverMethod; _i < _a.length; _i++) {
                var it = _a[_i];
                _this.connection.off(it.methodName, it.method);
            }
        };
    }
...
var ISignalRHub_HubProxy = /** @class */ (function () {
    function ISignalRHub_HubProxy(connection) {
        ...
        this.getHelloWorld = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connection.invoke("GetHelloWorld")];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
