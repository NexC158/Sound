...
class MessageBuffer {
    ...
    _resend() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._connection.send(this._protocol.writeMessage({ type: IHubProtocol_1.MessageType.Sequence, sequenceId }));
    ...
    _ackTimer() {
        if (this._ackTimerHandle === undefined) {
            this._ackTimerHandle = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                try {
                    if (!this._reconnectInProgress) {
                        yield this._connection.send(this._protocol.writeMessage({ type: IHubProtocol_1.MessageType.Ack, sequenceId: this._latestReceivedSequenceId }));
                    }
